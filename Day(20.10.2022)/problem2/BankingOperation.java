...
class BankOp { // class
	...
	public BankOp(int addAmount) { // 2nd constructor
	...
	public BankOp(String accountName, int accountBalance) { // 3rd constructor
		this.accountName = accountName;
		this.accountBalance = accountBalance;
	}
	...
	public BankOp(int widAmount, int Amount) { // 4th constructor
